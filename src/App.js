...
let [selectedScreen,setSelectedScreen] = useState('SelectionContainer')
 ...
 <div style={{margin:'20px auto', width:'70%'}} >
   <div style={{display:'inline-block'}}>
     <img src="https://omarbarbosahmh.github.io/blendingboard/assets/question.png" alt="question" width='90px'></img>
     </div>
  {selectedScreen==='MainContainer' && <div style={{float:'right',display:'inline-block',cursor:"pointer"}} onClick={()=>setSelectedScreen("SelectionContainer")}>
     <img src="https://omarbarbosahmh.github.io/blendingboard/assets/burguer.png" alt="burguer icon" width="60px"></img>
     </div>}
     ...
     <img src="https://omarbarbosahmh.github.io/blendingboard/assets/check.png" alt="burguer icon" width="80px"></img>
     </div>}
